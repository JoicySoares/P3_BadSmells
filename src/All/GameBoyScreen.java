...
class GameBoyScreen extends Frame implements ActionListener, ComponentListener,
		ItemListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (command.equals("Open ROM")) {
			...
			if (fd.getFile() != null) {
				applet.cartridge = new Cartridge("/home/joicy/Área de Trabalho/JavaBoy/Rom/pokemon_-_blue_version.zip", this);
